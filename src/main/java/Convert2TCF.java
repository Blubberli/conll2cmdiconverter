...
public class Convert2TCF {

    /**
     * Convert CoNNL-U to TCF file
     * @param input filepath of CoNNL-U file
     * @param output OutputStream for TCF file
     * @throws WLFormatException
     */
    public void convert(String input, OutputStream output) throws WLFormatException {
     ...
     * @param input filepath of CoNNL-U file
     * @param output OutputStream for TCF file
     * @param language of the CoNNL-U file
     * @throws WLFormatException
     */
    public void convert(String input, OutputStream output, String language) throws WLFormatException {
        if (language == null) {
            language = "de";
        }
        ...
        TextCorpusStored textCorpus = new TextCorpusStored(language);
    ...
    public static void main(String[] args) throws IOException {
        if (args.length != 2) {
            ...
            System.out.println("PATH_TO_INPUT_CONLLU");
            System.out.println("PATH_TO_OUTPUT_TCF");
        }

        try (FileOutputStream fos = new FileOutputStream(args[1])) {
            Convert2TCF creator = new Convert2TCF();
            creator.convert(args[0], fos, "de");
        }
    }
}
